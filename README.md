...
Інтернет-магазин одягу на Django. Мінімалістичний дизайн. Мета - Допомогти людям купувати одяг, щоб виділятися, а не бути схожим.
...
| Додаток | Призначення |
|---------|-------------|
| `products` | Каталог: моделі `Category` та `Product`,кешування категорій |
